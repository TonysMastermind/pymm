...
.. table:: Prefix properties of a game tree (\$: problem size <= possible scores, \+: optimal split, \*: root code not a solution.)
  ...
  ([2100], [4030], [5410])                         12           39             10           1           39         1,294
  ...
  ([2100], [4030], [5410], [0500])   \$\*\+         6            6              1           1            6         1,293
  ([2100], [4030], [5410], [1000])   \$\*\+         3            3              1           1            3         1,293
  ([2100], [4030], [5410], [1310])     \$\+         2            3              1           1            3         1,293
  ([2100], [4030], [5410], [4205])     \$\+         4            5              1           1            5         1,293
  ([2100], [4030], [5410], [4223])   \$\*\+        10           10              1           1           10         1,293
  ([2100], [4030], [5410], [5240])     \$\+         2            3              1           1            3         1,293
